...
class details extends StatefulWidget {
  final Post post;
  details({Key? key, required this.post})
      : super(key: key);
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        SizedBox(width: 5,),
                        Text(widget.post.status , style: TextStyle(fontSize: 12 , fontWeight: FontWeight.w300, fontFamily: 'Lexend'),)
                      ],
                    ),
              ...
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(widget.post.name, style: TextStyle(fontSize: 20 , fontFamily: 'Lexend' , fontWeight: FontWeight.w500),),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 6,),
                    Text(widget.post.latitute, style: TextStyle(fontSize: 12 , fontWeight: FontWeight.w400 , fontFamily: 'Lexend'),)
                  ],
                ),
              ),
              Padding(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(widget.post.transactionType, style: TextStyle(fontSize: 13 , fontWeight: FontWeight.w600 , fontFamily: 'Lexend'),),
                  ],
                ),
              ),
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(widget.post.propertyOwnership, style: TextStyle(fontSize: 13 , fontWeight: FontWeight.w600 , fontFamily: 'Lexend'),),
                  ],
                ),
              ),
              (buy == true)?Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(widget.post.postBidDetails.currentBid.toString(), style: TextStyle(fontSize: 13 , fontWeight: FontWeight.w600 , fontFamily: 'Lexend'),),
                  ],
                ),
              ):SizedBox(),
              (buy == true)?Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(widget.post.postBidDetails.minimumBid.toString(), style: TextStyle(fontSize: 13 , fontWeight: FontWeight.w600 , fontFamily: 'Lexend'),),
                  ],
                ),
              ):SizedBox(),
                      ...
                      Container(
                        ...
                        child: Row( mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: [
                            ...
                            Text(widget.post.area, style: TextStyle(fontFamily: 'Lexend' , fontWeight: FontWeight.w400 , fontSize: 13),)
                          ],
                        ),
                      ),
                      SizedBox(width: 10,),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width:10 ,),
                    Text(widget.post.latitute + " , ${widget.post.longitude}"  ,
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width:10 ,),
                    Text(widget.post.keywords[0] + " , ${widget.post.keywords[1]} , ${widget.post.keywords[2]}"  ,
                      style: TextStyle(fontSize: 14 , fontWeight: FontWeight.w300 , fontFamily: 'Lexend'),)
                  ],
                ),
              ),
